      ...
      <div className="mx-auto px-6 relative z-10" style={{ maxWidth: "var(--max-width)" }}>
        ...
        <div className="md:hidden mb-8 w-full relative z-30">
          <button
            ...
            className="w-full flex items-center justify-between bg-white border border-[#1B5E30]/20 rounded-2xl px-4 py-2.5 text-[13px] font-extrabold uppercase tracking-[1px] text-slate-850 shadow-sm focus:outline-none transition-all duration-300"
            style={{
